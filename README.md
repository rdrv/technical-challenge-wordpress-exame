...
- Se desejar, [crie um novo usuário e senha, com a função de editor](#crie-um-novo-usuario-editor). Faça o login novamente, para ver como o dash dele é mais limpo e adaptado as necessidades que ele terá.

Crie um novo usuário editor
